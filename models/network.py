...
class Network(object):
	...
	def load(cls, path, modified_args):
		...
		with open(params_path) as f:
			...
			'regularization','overlap_coef','loss','beta','model_folder', 'type','pretraining', 'with_silence', 'end_assign',
			'beta_kmeans', 'nb_tries', 'nb_steps', 'threshold', 'optimizer', 'men', 'women', 'recurrent_dropout', 'recurrent_dropout_enhance']
